...
\title{Currículum Vit\ae, Marzo 2018}                               % optional, remove / comment the line if not wanted
...
\cventry{2018}{Ingeniero programador e Investigador}{CoinFabrik}{Buenos Aires, Argentina}{}
{Análisis cuantitativo: Investigación y desarrollo de códigos.
Tareas desarrolladas:%
\begin{itemize}%
\item Análisis de correlaciones y cointegraciones en criptomonedas.
\item Análisis de estrategias de \textit{pair-trading} con posición neutral en el mercado.
\item Análisis de algoritmos de reversión de la media.
\end{itemize}
Análisis de datos con técnicas de \textit{machine learning}.
Tareas desarrolladas:%
\begin{itemize}%
\item Implementación de algoritmos de clasificación de textos por contenido, capaces de predecir clasificación en nuevos textos.
\item Implementación de algoritmos de redes neuronales recurrentes para analizar series temporales.
\end{itemize}
%\newline{}
Referencias: Eng. Sebastian Raul Wain (\href{mailto:sebastian.wain@nektra.com}{sebastian.wain@nektra.com}).}
...
\cvlistitem{Librerías científicas: {cuRAND, GNU Scientific Library (GSL), Matplotlib, NumPy, OpenMP, OpenMPI, PETSc, PyBrain, PyFoam, SLEPc, ScyPy, Thrust}}
