...
\title{Currículum Vit\ae, Mayo 2018}                               % optional, remove / comment the line if not wanted
...
\end{itemize}
Procesamiento de lenguage natural para análisis de documentos de texto.
Tareas desarrolladas:%
\begin{itemize}%
\item Clasificación incremental de documentos usando técnicas de expansión de vectores.
\item Clasificación en línea de noticias de último momento (\textit{breaking news online clustering}, tweets y otros artículos de redes sociales.
\end{itemize}
%\newline{}
